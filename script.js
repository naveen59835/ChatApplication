...
window.onload = function() {
    ...
    class MEME_CHAT{
      ...
      create_title(){
        ...
        title.textContent = 'FRIENDS CHAT'
      ...
      refresh_chat() {
        ...
        db.ref('chats/').on('value', function(messages_object) {
          ...
          // If there are no messages in the chat, return and don't load anything
          ...
          for (var i = 0; i < messages.length; i++) {
            ...
            guide.push(i + 1);
            // Unordered is [message, index_of_the_message]
          ...
          guide.forEach(function(key) {
            ...
            unordered = unordered.filter(function(item) {
              if (!found && item[1] == key) {
                // Now push the ordered messages to the ordered array
                ordered.push(item[0]);
                found = true;
                return false;
              } else {
          ...
          ordered.forEach(function(data) {
            ...
            var currentUser = app.get_name();
            if (name === currentUser) {
              // Align sender's messages to the left
              message_container.classList.add('sender');
            } else {
              // Align receiver's messages to the right
              message_container.classList.add('receiver');
            }
